...
<img class="icon" alt="Anemone Tentacle - Printed and assembled from right" src="https://github.com/ceskasporitelna/anemone/blob/master/documentation/images/assembled_tentacle/0_assembled_tentacle_alpha_right.png?raw=true" height="300"> <img class="icon" alt="Anemone Tentacle - Printed and assembled from left" src="https://github.com/ceskasporitelna/anemone/blob/master/documentation/images/assembled_tentacle/0_assembled_tentacle_alpha_left.png?raw=true" height="300"> <img class="icon" alt="Anemone Tentacle - Printed, assembled and running" src="https://github.com/ceskasporitelna/anemone/blob/master/documentation/images/assembled_tentacle/7_assembled_tentacle_ running_app.jpg?raw=true" height="300">
