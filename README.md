...
* [Anemone Toolkit](https://github.com/ceskasporitelna/anemone/tree/master/toolkit) which you need in order to create a Tentacle or build Anemone App
* [Anemone Apps Repository](https://github.com/ceskasporitelna/anemone/tree/master/apps)
* [Anemone Cloud Connectors List](https://github.com/ceskasporitelna/anemone/tree/master/connectors)
...
> The **Anemone Platform is completely OPEN**. Everybody can [become a user by signing up for free](http://www.anemone.cloud/users/sign_up). Every user can either receive a guest access or can [build his own](https://github.com/ceskasporitelna/anemone/blob/master/documentation/HowToBuildAnemoneTentacle.md) Tentacle. To a Tentacle he can then install some apps from our [public repository of Anemone Apps](https://github.com/ceskasporitelna/anemone/tree/master/apps) or he can [create his own app](https://github.com/ceskasporitelna/anemone/blob/master/documentation/HowToMakeAnemoneApp.md).
